<!-- repository: services/seat | kind: SERVICE | stack: nestjs -->

# seat — Skill: Service Development

> Workflow for seat (services/seat). Execute this workflow before, during, and
...
- Keep tenant isolation intact (`Concurrency-sensitive seat availability; tenant isolation mandatory.`).
