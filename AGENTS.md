...
> Repository development instructions for **seat** (Service).
...
src/adapter, admin, analytics, config, core, event-auth, handlers, layout, prisma, seat, section, security, table, utils
